...
export default function Header({ company_name, title, index, setting }) {
    ...
    <div className="flex">
      ...
      <div className="text-center flex justify-center items-center flex-1">
        <div className="">
          <h2 className="text-[#1d8ef2] text-[1.75vw] font-bold tracking-wider mb-2 font-poppins">
            {company_name || "Titas Gas Transmission & Distribution PLC."}
          </h2>
          <p style={{color: titleColor, textDecoration: "underline"}} className="text-[1.35vw] font-bold font-poppins">{title}</p>
        </div>
      </div>
    </div>
  );
